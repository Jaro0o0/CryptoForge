          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
            ...
            <div className="lg:col-span-7 flex flex-col justify-center">
              ...
              <motion.span
                ...
                className="self-start inline-block text-xs font-semibold uppercase tracking-wider text-cyan-400 bg-cyan-500/10 border border-cyan-500/20 rounded-full px-4 py-1.5 mb-6"
              >
                Mobile Experience
              </motion.span>
              <motion.h2
              ...
              <motion.p
                ...
                className="text-slate-300 text-base md:text-lg mb-8 leading-relaxed max-w-xl"
              >
